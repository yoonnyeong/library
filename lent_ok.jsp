...
<h2>대출 완료</h2>
<hr>
<%=login.getUserid() %>님, 대출이 완료되었습니다.
<br>감사합니다 :)
<br><br>
[<a href="menu.jsp">메인 화면으로</a>]
[<a href="Bookslist_member.jsp">상품 목록으로</a>]
<%;
...
<TABLE border='1' cellspacing=1 cellpadding=2 width='600'> 
	<TR bgcolor="#99CC00">
		...
		<TD align='center' width='250'>도서 코드</TD>
		<TD align='center' width='250'>도서 명</TD>
		<TD align='center' width='250'>대여 일자</TD>
		<TD align='center' width='250'>반납 일자</TD>
	</TR>
<%
	for(Lent lent:datas ){
